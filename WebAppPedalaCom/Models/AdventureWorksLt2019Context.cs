...
public partial class AdventureWorksLt2019Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__carts__3213E83FD2936E84");
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.Carts)
                ...
                .HasConstraintName("FK__carts__quantity__0C50D423");

            entity.HasOne(d => d.Product).WithMany(p => p.Carts)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__carts__product_i__0D44F85C");
        });
